#!/bin/bash
# install.sh - ROBOSHΞN™ one-line installer
...
if [[ ":$PATH:" != *":$HOME/.local/bin:"* ]]; then
    ...
    # اجرای خودکار source برای فعال‌سازی PATH در همین جلسه
...
# ===== پیام نهایی خیلی واضح =====
echo -e "\n${GREEN}🆒 Installation complete!${NC}"
echo -e "${GREEN}🆗  Just type:  roboshen${NC}"
echo -e "${GREEN}🆙  and press Enter.${NC}\n"
